...
namespace FitnessApp.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(FitnessAppContext context, IWebHostEnvironment hostEnvironment, UserManager<AppUser> userMgr)
        {
            _context = context;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,FName,LName,Birthdate,MainGoal,PhoneNumber,Email,Career,Height,Weight,Adress")] User user)
        {
